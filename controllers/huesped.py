...
class huesped():
    ...
    def insert(self, ced_hue, ape_hue, nom_hue, dir_hue, ciu_hue, email_hue, tel_hue):
        ...
        try:
            ...
            result = huesped_modelo.insert(ced_hue, ape_hue, nom_hue, dir_hue, ciu_hue, email_hue, tel_hue)
    ...
    def select_one(self, ced_hue):
        hue = huesped_modelo.select_one(ced_hue)
        return hue
    
    def update(self, ced_hue, ape_hue, nom_hue, dir_hue, ciu_hue, email_hue, tel_hue):
        ...
        try:
            ...
            result = huesped_modelo.update(ced_hue, ape_hue, nom_hue, dir_hue, ciu_hue, email_hue, tel_hue)
    ...
    def delete(self, ced_hue):
        result = huesped_modelo.delete(ced_hue)
        return result